...
# nf1 = "{0}/{1}-{2}-{3}-mem-alldata.txt".format(path, me, listid, tstr)
# nf2 = "{0}/{1}-{2}-{3}-mem-usernames.txt".format(path, me, listid, tstr)
# nf3 = "{0}/{1}-{2}-{3}-mem-summary.txt".format(path, me, listid, tstr)
# nf4 = "{0}/{1}-{2}-{3}-sub-alldata.txt".format(path, me, listid, tstr)
# nf5 = "{0}/{1}-{2}-{3}-sub-usernames.txt".format(path, me, listid, tstr)
# nf6 = "{0}/{1}-{2}-{3}-sub-summary.txt".format(path, me, listid, tstr)

nf1 = "{0}/{1}-{2}-{3}-mem-alldata.txt".format(path, me, listid, tstr)
nf2 = "{0}/{1}-{2}-{3}-mem-usernames.txt".format(path, me, listid, tstr)
nf3 = "{0}/{1}-{2}-{3}-sub-alldata.txt".format(path, me, listid, tstr)
nf4 = "{0}/{1}-{2}-{3}-sub-usernames.txt".format(path, me, listid, tstr)
nf5 = "{0}/{1}-{2}-{3}-summary.txt".format(path, me, listid, tstr)
